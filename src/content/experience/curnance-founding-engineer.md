...
type: founder
summary: Founding engineer at a multi-asset fintech for African markets. Set up the engineering organisation and shipped seven production services — ledger, auth, KYC/KYB, Go jobs handler, Flutter app, admin console — at 1,000+ daily transactions, 99.9% reliability.
highlights:
